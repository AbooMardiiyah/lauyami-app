...
@task(
    ...
    description="Ingest legal documents from SQL to Qdrant.",
    retries=2,
...
async def ingest_qdrant(from_date: datetime | None = None):
    ...
    Args:
        from_date (datetime | None, optional): Only ingest documents published after this date.
            Defaults to None (ingest all documents).
