...
from src.models.sql_models import Base, LegalDocument
...
def create_table() -> None:
    """Create the LegalDocument table in the Supabase Postgres database if it does not exist.

    This function initializes a SQLAlchemy engine, checks if the table defined by
    `LegalDocument.__tablename__` exists in the database, and creates it if necessary.
